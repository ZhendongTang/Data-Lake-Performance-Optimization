...
class Snapshot(table_info: TableInfo,
  ...
  private var userDefinedTimeStamp = 0L
  ...
  def setUserDefinedTimeStamp(userDefinedTimeStamp: Long): Unit ={
    this.userDefinedTimeStamp = userDefinedTimeStamp
  }
  def getUserDefinedTimeStamp: Long = {
    this.userDefinedTimeStamp
  }
